...
<body>
  <div class="p-3 mb-1 bg-primary text-black">
    ...
    <form method="post" action="solicitud.php" class="text-white">
        ...
        <button type="submit" name="aceptar" class="btn btn-outline-success" style="margin-top: 15px; color: black;"> mandar solicitud</button>
      </form>
